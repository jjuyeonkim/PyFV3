...
class TranslateJablonowskiBaroclinicSteady(TranslateDycoreFortranData2Py):
    ...
    def __init__(
        ...
        #for var in ["phis"]:
        #    self.ignore_near_zero_errors[var] = {"near_zero": 1e-12}
        #
        self.stencil_factory = stencil_factory
...
class TranslateJablonowskiBaroclinicInstability(TranslateDycoreFortranData2Py):
    """ Translate the Fortran initialization for the steady-state Baroclinic test case initialization.
    """
    def __init__(
        self,
